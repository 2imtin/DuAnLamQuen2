        ...
        <div class="container p-3 my-3">
            <div class="row border border-primary">
                <div class="col-md-6 border-right">
                    <h1 class="bg-success text-white text-center">Thông tin đăng nhập</h1>
                    ...
                    <div class="form-group">
                        ...
                        <asp:CompareValidator ID="cpvNLMK0" runat="server" ErrorMessage="Nhập lại mật khẩu không trùng khớp!" ControlToCompare="txtNhapLaiPass" ControlToValidate="txtPass" ForeColor="#FF0066"></asp:CompareValidator>
                    </div>
                    <h1 class="bg-success text-white text-center">Thông tin cá nhân</h1>
                    <div class="form-group">
                        <label for="txtHoTen">Họ tên khách hàng:</label>
                        <asp:TextBox ID="txtHoTen" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvTenKhachHang" runat="server" ErrorMessage="Họ tên không được rỗng" ControlToValidate="txtHoTen" ForeColor="#FF0066"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RadioButton ID="rdNam" Text="Nam" runat="server" GroupName="GT" checked/>
                        <asp:RadioButton ID="rdNu" Checked="true" Text="Nữ" runat="server" GroupName="GT" />
                ...
                <div class="col-md-6 ">
                    <h1 class="bg-success text-white text-center">Hồ sơ khách hàng</h1>
                    <div class="text-info">
