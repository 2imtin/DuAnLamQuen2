...
<body>
     <form id="form1" runat="server">
        <div class="container p-3 my-3 text-white text-center" style="background-color:#009999">
            ...
            <div class="form-group row mb-2">
                ...
                <asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Họ tên không được trống" ControlToValidate="txtHoTen" ForeColor="#990000"></asp:RequiredFieldValidator>
            ...
            <div class="form-group row mb-2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Chọn ngày sinh" ControlToValidate="txtNgaySinh" ForeColor="#990000"></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Chọn ngày sinh hợp lý" ControlToValidate="txtNgaySinh" ForeColor="#990000" Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
            </div>
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-sm-8 text-left">
                    <asp:RadioButton GroupName="rdGioiTinh" Text="Nam" Checked="true" ID="rdNam" runat="server" CssClass="form-check-input  float-left"  /> <br />
                    <asp:RadioButton GroupName="rdGioiTinh" Text="Nữ"  ID="rdNu" runat="server" CssClass="form-check-input  float-left" /> 
                </div>
            </div>
